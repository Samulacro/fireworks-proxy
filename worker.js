...
async function proxyStream(fireworksResponse, corsHeaders) {
  // Streaming: lê o ReadableStream do Fireworks e repassa chunk por chunk,
  // garantindo que cada chunk seja um pedaço válido de SSE
    ...
    async start(controller) {
      try {
        const processBuffer = (buffer) => {
          // Divide por linhas completas
          const lines = buffer.split('\n');
          // A última linha pode estar incompleta, guarda pra próxima
